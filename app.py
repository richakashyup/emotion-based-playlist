from flask import Flask, render_template, request # use to make web app
import numpy as np # to detect the face expression
import cv2 #to display the image on the window
from keras.models import load_model #for backend work
import webbrowser # to allow displaying web-based document to users.
